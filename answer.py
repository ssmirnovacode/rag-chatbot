...
SYSTEM_PROMPT = """
You are a knowledgeable, friendly assistant designed to help user with reevant information from the knowledge base.
...
def fetch_context_unranked(question):
    results = collection.query(
        query_embeddings=[hf_embeddings.embed_query(question)],
